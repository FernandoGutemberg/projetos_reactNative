...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/fernando/.vscode/extensions/wallabyjs.console-ninja-1.0.377/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20bc7e579ac0f901566b6eV00OUhsGA1AGAwUPVVdTAVIAUFZb', mode: 'build'}); } catch(cjsError) { try { import('file:///home/fernando/.vscode/extensions/wallabyjs.console-ninja-1.0.377/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20bc7e579ac0f901566b6eV00OUhsGA1AGAwUPVVdTAVIAUFZb', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
